...
The body of the loop will be executed for each integer element denoted by `c` found in the container `candies`. The loop continues until all elements in `candies` have been traversed.
